 ...
 * metoda klasa omotača osnovnih tipova.
 */
public class PretvorbaTipova{
	/**
	 * Metoda demonstrira pretvorbu između različitih brojčanih 
	 * osnovnih tipova podataka i niza znakova pomoću metoda klasa 
	 * omotača brojeva (Integer, Double,...)
	 */
    public void casting() {
    	// Broj zadan kao niz znakova (String)
        String sNum = "246";
