...
public class PrimjerListe 
{
    ...
    private void listaCijelih(){
        Integer broj;
        // implementacija liste statièkim poljem
        ...
        // èitaj sve elemente liste (klasièan for)        
        ...
        // èitaj sve elemente liste (for-each)  - sortirani ispis
    ...
    private void listaSvih(){
        ...
        if (lista2.contains(broj)){
            ...
            System.out.println(broj +" se ne nalazi u listi!");        
        // èitaj sve elemente liste (for-each)  
